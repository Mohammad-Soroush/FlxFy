    ...
    <div className="categories mt-10 mb-72">
      ...
      <div className="itemcategories grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-6">
        <div className="Homerepairs bg-white p-4 rounded-xl text-center shadow-sm hover:shadow-md transition">
          <img src="/assets/Categories/Vector.png" alt="" className="w-12 mx-auto mb-2 max-w-full h-auto" />
          <p>Home repairs</p>
        </div>
        <div className="Homerepairs bg-white p-4 rounded-xl text-center shadow-sm hover:shadow-md transition">
          <img src="/assets/Categories/Baker.png" alt="" className="w-12 mx-auto mb-2 max-w-full h-auto" />
          <p>Baking</p>
        </div>
        <div className="Homerepairs bg-white p-4 rounded-xl text-center shadow-sm hover:shadow-md transition">
          <img src="/assets/Categories/Fixer.png" alt="" className="w-12 mx-auto mb-2 max-w-full h-auto" />
          <p>Fixing</p>
        </div>
        <div className="Homerepairs bg-white p-4 rounded-xl text-center shadow-sm hover:shadow-md transition">
          <img src="/assets/Categories/Vector.png" alt="" className="w-12 mx-auto mb-2 max-w-full h-auto" />
